...
const title = ref(
	schoolName ? `Libro - ${schoolName} - Intranet` : 'Libro - Intranet',
)
// Nuxtp
const { $fetchModule, $libraryService, $filesService } = useNuxtApp()
// Router
	...
	<section v-if="book" class="Book">
		...
		<section class="Header">
			<figure class="Header__image">
				...
				<a
					target="_blank"
					:href="`/biblioteca/autor/${(book.author as Author).slug}`"
				>
					Autor:
					<span class="Author">{{
				...
				<section class="Tags">
					...
					<small
						v-for="(tag, i) in (book.tags as Array<Tag>)"
						:key="i"
					>
						{{ tag.tag }}
