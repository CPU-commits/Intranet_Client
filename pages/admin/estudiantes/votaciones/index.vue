    ...
    <NuxtLayout name="admin">
        <AdminPanel :nav="false">
            ...
            <HTMLForm :form="uploadVoting">
                ...
                <article v-for="(list, i) in votingForm.lists" class="List" :key="i">
                ...
                <HTMLButtonIcon classItem="fa-solid fa-plus" :click="addList" title="Añadir lista" />
                <label for="start">Fecha comienzo votaciones</label>
                <HTMLInput type="date" id="start" v-model:value="votingForm.start_date" />
                <label for="finish">Fecha termino votaciones</label>
                <HTMLInput type="date" id="finish" v-model:value="votingForm.finish_date" />
                <label for="period">Periodo de direcci&oacute;n (Meses)</label>
                <HTMLInput type="number" id="period" v-model:value="votingForm.period" />
