...
// Props
const { notification, toggleMenu } = defineProps<{
...
<template>
    <article class="Notification">
        <NuxtLink
            @click="toggleMenu"
            :to="notification.notification.url"
        >
            <img
            ...
            <div class="Notification__text">
                ...
                <span v-if="notification.notification.type === 'classroom' && notification.notification.subject">
                    Materia:
        ...
        <button @click="deleteNotification" class="Notification__delete">
