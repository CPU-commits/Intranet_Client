...
// Props
const { publication, idModule, canEdit } = defineProps<{
...
async function editPublication() {
    ...
    if (edited) {
        publication.content.content = editPublicationText.value
...
<template>
    <article class="Publication">
        <aside v-if="canEdit">
            ...
            />
            <div class="Publication__config" :class="open ? 'Publication__config--open' : ''">
                <button
        ...
        <footer class="Publication__footer">
            <div class="Publication__footer--info">
                ...
                <small v-if="publication.update_date.toString() !== publication.upload_date.toString()">
