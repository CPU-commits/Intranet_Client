...
<template>
    <section class="Form__questions">
        ...
        <HTMLSelect v-model:value="item.questions[buildForm.getQuestion].type" id="question__type">
        ...
        <div class="Form__questions--block">
            ...
            <span v-if="item.questions.length === 0">
                Sin preguntas
            </span>
        </div>
        <template v-if="item.questions[buildForm.getQuestion].type.includes('alternatives')">
            <h4>Alternativas</h4>
            <section class="Answers">
                <div
                    v-for="(_, i) in item.questions[buildForm.getQuestion].answers"
                    :key="i"
                    class="Answer"
                >
                    <span>{{ i + 1 }})</span>
                    <input
                        v-if="item.questions[buildForm.getQuestion].type === 'alternatives_correct'"
                    ...
                    <HTMLInput
                        ...
                        v-model:value="item.questions[buildForm.getQuestion].answers[i]"
                        id="alternative"
                    />
                    <HTMLButtonIcon
        ...
        <template v-else-if="item.questions[buildForm.getQuestion].type === 'written'">
